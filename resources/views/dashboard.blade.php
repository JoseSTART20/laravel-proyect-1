    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-4">
            <div class="bg-white dark:bg-gray-800 overflow-hidden sm:rounded-lg relative">
                <img src="{{ asset('img/imagen1.jpg')}}" alt="img" class="aspect-video h-64 w-full rounded-[10px] object-top object-cover"/>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-4">
            <div class="bg-white dark:bg-gray-800 overflow-hidden sm:rounded-lg">
                <div class="p-6">
                    <a class="text-xl font-semibold text-black dark:text-white" href="{{url('activities')}}">Mas proyectos</a>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-4">
            <div class="bg-white dark:bg-gray-800 overflow-hidden sm:rounded-lg">
                <div class="p-6">
                    <a class="text-xl font-semibold text-black dark:text-white" href="{{url('proyects')}}">Sobre mi</a>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-4">
            <div class="bg-white dark:bg-gray-800 overflow-hidden sm:rounded-lg">
                <div class="p-6">
                    <a class="text-xl font-semibold text-black dark:text-white" href="{{url('services')}}">Experiencia profecional</a>
                    <p class="mt-4 text-sm text-gray-900 dark:text-gray-100">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempora dolor ab, eligendi, debitis iusto laborum hic, temporibus facere animi sit similique perspiciatis unde eveniet aliquam eius eos commodi quidem earum!</p>
                </div>
            </div>
        </div>
